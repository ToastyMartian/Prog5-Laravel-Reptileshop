...
@section('content')
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            <h5 class="card-title"><a href="#" class="text-white text-decoration-none">Kikkers</a></h5>
            ...
            <a href="#" class="btn btn-primary btn-dark"><small class="text-muted">Bekijk kikkers te koop</small></a>
        </div>
    </div>
    <div class="card bg-dark text-white">
    ...
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            <h5 class="card-title"><a href="#" class="text-white text-decoration-none">Salamanders</a></h5>
