...
@section('content')
    <table class="table">
        ...
        <tr>
            ...
            <td><a href="{{route('posts.edit', $post->id)}}" class="btn btn-success">Wijzig post</a></td>
            <td><a href="{{route('posts.destroy', $post->id)}}" class="btn btn-danger">Verwijder post</a></td>
        </tr>
        @endforeach
        </tbody>
    </table>
