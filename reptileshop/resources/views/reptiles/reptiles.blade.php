...
@section('content')
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <a href="#" class="btn btn-primary btn-dark"><small class="text-muted">Bekijk slangen te koop</small></a>
        </div>
    </div>
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <a href="#" class="btn btn-primary btn-dark"><small class="text-muted">Bekijk hagedissen te koop</small></a>
        </div>
    </div>
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <a href="#" class="btn btn-primary btn-dark"><small class="text-muted">Bekijk schildpadden te koop</small></a>
        </div>
    </div>
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <a href="#" class="btn btn-primary btn-dark"><small class="text-muted">Bekijk krokodilachtigen te koop</small></a>
        </div>
    </div>
